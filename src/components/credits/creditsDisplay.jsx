...
export default function CreditsDisplay({ credits, onAddCredits, width }) {
    return (
        <a href='/pricing'>
        <button className={`flex h-[2.5rem] w-${width} items-center justify-between px-3 space-x-2 border border-muted-foreground/30 rounded-full bg-secondary/80 hover:bg-secondary hover:shadow-[0_0_3px_#0000ff] transition-all duration-500`}>
