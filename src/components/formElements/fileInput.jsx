...
const FileInput = ({registerId, register, label}) => {
    return (
        <div>
            <Label htmlFor={registerId} className="bg-secondary h-[4rem] w-full flex justify-center items-center rounded-lg text-center text-[1.5rem] tracking-widest shadow-inner">
                {label}
            </Label>
